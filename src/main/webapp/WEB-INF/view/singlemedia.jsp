...
<div class="container-fluid">
	...
	<div class="row">
            <div id="navi" class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 mr-3 animated">
                  <h1>Upload Media</h1>
                  <hr/><br/> 
                  <a href="singlemedia"><button id="l" class="btn-primary active">Single Media</button></a><br/>
                  <a href="multiplemedia"><button id="r" class="btn-primary">Multiple Media</button></a>
            </div>
...
<h1>New Media Page</h1>
        <hr/>
        <br/>
        <table class="table table-borderless ml-3 animated">
