    ...
    <br/>
        <nav id="header" class="navbar navbar-expand-md ">
          ...
          <ul style="float: right;margin-top: -30px;margin-right: 15px;" class="list-inline">
                ...
                <li class="list-inline-item"><a href="#">Following</a></li>     
        </ul>
</div>
<br/>
<hr/>
...
<div class="container-fluid">
        ...
        <div class="row">
                <div class="col-12 col-md-12 col-lg-3 col-xl-3">
                    <div class="card text-dark ml-2 mr-2  mb-3 animated"  id="card1">
                            <div class="card-body img-center">
                                    <table class="table-style">
                                            ...
                                            <tr>
                                                <td>
                                                        <i class="fa fa-camera-retro" aria-hidden="true"></i>32
                                                </td>
                                                <td>
                                                        <i class="fa fa-tags" aria-hidden="true"></i>28
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <div class="card-footer">
                                    <button  class="btn btn-danger btn-block">Follow/UnFollow</button>
                                </div>
                    </div>
                </div>

                <div class="col-12 col-md-12 col-lg-3 col-xl-3">
                        <div class="card text-dark mr-2 mb-3 animated"  id="card2">
                                <div class="card-body img-center">
                                        <table class="table-style">
                                                <tr>
                                                    <td>
                ...
                <div class="col-12 col-md-12 col-lg-3 col-xl-3">
                        <div class="card text-dark mr-2  mb-3 animated"  id="card4">
                                <div class="card-body img-center">
                                        <table class="table-style">
                                                <tr>
                                                    <td>
                        ...
                        <div class="col-12 col-md-12 col-lg-3 col-xl-3">
                                <div class="card text-dark mr-2 mb-3 animated"  id="card34">
                                        <div class="card-body img-center">
                                                <table class="table-style">
                                                        <tr>
                                                            <td>
            ...
            <div class="row">
                    <div class="col-12 col-md-12 col-lg-3 col-xl-3">
                            <div class="card text-dark mr-2 ml-2 mb-3 animated"  id="card34">
                                    <div class="card-body img-center">
                                            <table class="table-style">
                                                    <tr>
                                                        <td>
